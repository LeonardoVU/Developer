...
import { BaseComponentProps } from "babylonjs-node-particle-editor/fluent/hoc/propertyLines/propertyLine";
...
import { FunctionComponent } from "react";
import { BaseComponentProps, PropertyLineProps } from "babylonjs-node-particle-editor/fluent/hoc/propertyLines/propertyLine";
...
declare module BABYLON.NodeParticleEditor.SharedUIComponents {
        type FileUploadLineProps = Omit<BABYLON.NodeParticleEditor.SharedUIComponents.ButtonProps, "onClick"> & {
        onClick: (files: FileList) => void;
        accept: string;
    };
...
declare module BABYLON.NodeParticleEditor.SharedUIComponents {
     ...
     * @returns A button inside a line
     */
    export var ButtonLine: React.FunctionComponent<BABYLON.NodeParticleEditor.SharedUIComponents.ButtonProps>;
